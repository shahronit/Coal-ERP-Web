...
**Service:** [coal-erp-web](https://coal-erp-web.onrender.com) · [Dashboard](https://dashboard.render.com/web/srv-d8uqqfok1i2s73e9e3pg)

The Docker web service is created on Render. Complete setup by adding **DATABASE_URL** (see [docs/RENDER.md](docs/RENDER.md)):

1. **Quick:** coal-erp-web → **Environment** → **Add from Database** (or paste a Neon/Supabase URL)
2. **Full stack:** Add billing → [Apply Blueprint](https://dashboard.render.com/blueprint/new?repo=https://github.com/shahronit/Coal-ERP-Web)
3. Redeploy — login: `superadmin@tradecrm.com` / `Demo@123`
